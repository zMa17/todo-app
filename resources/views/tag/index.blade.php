<x-app-layout>
    <div class="max-w-3xl mx-auto px-8 py-8">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('tag.create') }}" class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-white bg-amber-400 hover:bg-amber-500 rounded-lg transition-colors">
