<x-app-layout>
    <div class="max-w-xl px-8 py-8">
        <div class="flex items-center gap-3 mb-6">
            <a href="{{ route('tag.index') }}" class="text-gray-400 hover:text-gray-600">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m7 7l-7-7 7-7"/>
                </svg>
            </a>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Tag</h1>
        </div>
        ...
        <div class="bg-white border border-[#e5e5e4] rounded-lg p-6">
            <form action="{{ route('tag.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="color" name="warna" id="warna" value="{{ old('warna', '#f59e0b') }}" required
