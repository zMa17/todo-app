<div id="kategori-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div class="relative bg-white border p-6 rounded-lg" style="width:360px">
        ...
        <form action="{{ route('kategori.store') }}" method="POST">
            ...
            <div class="mb-3">
                <input type="color" name="warna" value="#6366f1" class="border rounded-lg" required>
            </div>
            <button type="submit" class="w-full py-2 bg-amber-400 text-white rounded-lg" style="border:none">Tambah</button>
        </form>
    </div>
</div>